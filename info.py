...
URL = "https://mz-filter-bot.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://mz-filter-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://mz-filter-bot.onrender.com/".format(FQDN)
else:
    URL = "https://mz-filter-bot.onrender.com/".format(FQDN)
