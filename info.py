...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/How_To_Open_pkinme")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://baryogi970:4wjsqm33pEMEwsjH@cluster0.ppavadm.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'rGnAjVtF8IST9FXHD9eeEnpvDfR2')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/VisionLoverzMovieRequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mzmoviiez')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_pkinme')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001808353017'))
...
URL = "https://mz-filter-bot-062z.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://mz-filter-bot-062z.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://mz-filter-bot-062z.onrender.com/".format(FQDN)
else:
    URL = "https://mz-filter-bot-062z.onrender.com/".format(FQDN)
